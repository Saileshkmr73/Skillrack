...
The program must accept two integers N and K as the input. The program must print the count of integers from 1 to N having the sum of digits divisible by K.
